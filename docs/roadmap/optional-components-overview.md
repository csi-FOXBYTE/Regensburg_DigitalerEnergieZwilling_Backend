...
| Einbindung von Geothermiedaten | Fachliche Erweiterung / Datenbasis | Gebäudebezogene Auswertung der vom Auftraggeber bereitgestellten Daten in der Reihenfolge Grundwasser, Erdreich, Luft. | [FA-05](../requirements/02-functional-requirements.md#fa-05), [FA-104](../requirements/02-functional-requirements.md#fa-104), [TA-13](../requirements/03-technical-requirements.md#ta-13), [TA-100](../requirements/03-technical-requirements.md#ta-100), [TA-101](../requirements/03-technical-requirements.md#ta-101) | Sprint 17 / Release 7 | Technische Integration nach Datenfreigabe in Sprint 17 umgesetzt. Herkunfts-, Lizenz-, Turnus- und Schemametadaten sind vor der produktiven Veröffentlichung zu klären. | Teilweise umgesetzt |

...
export type DeletionAuditEvent = $ModelResult<$Schema, "DeletionAuditEvent">;
...
export const DeletionAuditAction = $schema.enums.DeletionAuditAction.values;
export type DeletionAuditAction = (typeof DeletionAuditAction)[keyof typeof DeletionAuditAction];
export const DeletionAuditActorType = $schema.enums.DeletionAuditActorType.values;
export type DeletionAuditActorType = (typeof DeletionAuditActorType)[keyof typeof DeletionAuditActorType];
export const FeedbackCategory = $schema.enums.FeedbackCategory.values;

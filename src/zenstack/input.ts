...
export type DezConfigFindManyArgs = $FindManyArgs<$Schema, "DezConfig">;
export type DezConfigFindUniqueArgs = $FindUniqueArgs<$Schema, "DezConfig">;
export type DezConfigFindFirstArgs = $FindFirstArgs<$Schema, "DezConfig">;
export type DezConfigExistsArgs = $ExistsArgs<$Schema, "DezConfig">;
export type DezConfigCreateArgs = $CreateArgs<$Schema, "DezConfig">;
export type DezConfigCreateManyArgs = $CreateManyArgs<$Schema, "DezConfig">;
export type DezConfigCreateManyAndReturnArgs = $CreateManyAndReturnArgs<$Schema, "DezConfig">;
export type DezConfigUpdateArgs = $UpdateArgs<$Schema, "DezConfig">;
export type DezConfigUpdateManyArgs = $UpdateManyArgs<$Schema, "DezConfig">;
export type DezConfigUpdateManyAndReturnArgs = $UpdateManyAndReturnArgs<$Schema, "DezConfig">;
export type DezConfigUpsertArgs = $UpsertArgs<$Schema, "DezConfig">;
export type DezConfigDeleteArgs = $DeleteArgs<$Schema, "DezConfig">;
export type DezConfigDeleteManyArgs = $DeleteManyArgs<$Schema, "DezConfig">;
export type DezConfigCountArgs = $CountArgs<$Schema, "DezConfig">;
export type DezConfigAggregateArgs = $AggregateArgs<$Schema, "DezConfig">;
export type DezConfigGroupByArgs = $GroupByArgs<$Schema, "DezConfig">;
export type DezConfigWhereInput = $WhereInput<$Schema, "DezConfig">;
export type DezConfigSelect = $SelectInput<$Schema, "DezConfig">;
export type DezConfigInclude = $IncludeInput<$Schema, "DezConfig">;
export type DezConfigOmit = $OmitInput<$Schema, "DezConfig">;
export type DezConfigGetPayload<Args extends $SelectIncludeOmit<$Schema, "DezConfig", true>, Options extends $QueryOptions<$Schema> = $QueryOptions<$Schema>> = $Result<$Schema, "DezConfig", Args, Options>;
